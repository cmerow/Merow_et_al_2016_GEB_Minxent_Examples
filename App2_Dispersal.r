...
# add legend
  image(me.real ,col='white',xaxt='n', yaxt='n', bty='n',main='',cex.main=2.2, zlim=c(0,z.max))
  image.plot(me.real,legend.only=TRUE,col=cols1(100),xaxt='n', yaxt='n', bty='n',main='',
