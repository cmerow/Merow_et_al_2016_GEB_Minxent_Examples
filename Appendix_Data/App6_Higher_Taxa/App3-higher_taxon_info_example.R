...
if( !file.exists( "Maxent_output/PRNANA_PRECIS" ) ) { dir.create( "Maxent_output/PRNANA_PRECIS" ) }
...
if( !file.exists( "Maxent_output/PRNANA_PRECIS_bias" ) ) { dir.create( "Maxent_output/PRNANA_PRECIS_bias" ) }
